...
const CardFlip = () => {
  ...
  return (
    <div className='flex h-[800px] cursor-pointer items-center justify-center'>
      <div className='flip-card h-[180px] w-[300px] rounded-md' onClick={handleFlip}>
        <motion.div
          ref={containerRef}
        ...
        >
          ...
          >
            <p className='text-sm leading-relaxed'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod animi iusto corrupti blanditiis tempore
              vitae incidunt deserunt natus?
            </p>
          </div>
        </motion.div>
      </div>
