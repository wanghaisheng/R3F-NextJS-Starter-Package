          ...
          {user && (
            <>
              <div className='mt-10 flex size-full lg:justify-end'>
                <div className='flex h-fit w-full flex-col flex-wrap justify-start rounded-xl bg-[#f5f5f5] p-3 backdrop-blur-md lg:mr-14 lg:w-[67%] lg:p-8 lg:shadow lg:shadow-purple-500 dark:bg-transparent dark:lg:bg-purple-950/20'>
                  <div>
