...
const Card = ({ cityName, humidity, temperature, windSpeed, visibility, icon, weatherStatus, weatherDescription }) => {
  ...
  return (
    <>
      {!clicked ? (
        <div
          className='absolute right-2 top-2 cursor-pointer rounded-full bg-white/40 shadow-md shadow-white transition duration-1000 hover:scale-105 hover:shadow-pink-600 hover:duration-200'
          onClick={handleClick}
        >
        ...
        <div className='h-1/2 rounded-lg bg-gradient-to-r from-white bg-cover bg-center bg-no-repeat p-6 shadow-lg shadow-white transition duration-1000 hover:scale-105 hover:shadow-pink-600 hover:duration-300'>
          <button
          ...
          <div className='text-md mt-6 flex justify-between bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text font-semibold text-transparent drop-shadow-sm'>
