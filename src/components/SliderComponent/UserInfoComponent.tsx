  ...
  return (
    <>
      <div className='-ml-3 mb-12 mt-2 flex flex-col items-center md:ml-0 lg:mb-0 '>
        <div
          id='Genius ID'
          className='relative flex h-[900px] w-[300px] bg-violet-300 py-4 md:w-[500px] md:rounded-3xl md:px-10 md:shadow-md md:shadow-purple-700 md:backdrop-blur-md lg:h-[550px] lg:w-[800px] md:dark:bg-black/10'
        >
