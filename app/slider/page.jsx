    ...
    <div className='flex flex-col items-center'>
      ...
      <div className='bg-[#F8F8F8]/7 flex h-full w-fit rounded-[30px] border-4 border-[#2E2B3C] px-10 py-4'>
        <div className='flex flex-col '>
          <div className='flex justify-center text-7xl'>Skills</div>
          <div className='flex w-[240px] items-center rounded-[20px] bg-black px-4 py-2 shadow-sm shadow-white'>
            <button onClick={handleAddSkill}>Add New Skill &emsp; &emsp; +</button>
          </div>
          <div className='flex'>
            <div className='flex flex-col'>
              <div className='flex'>
                {skills.map((skill, index) => (
                  <div key={index}>
                    <nav className='ml-7 flex justify-center'>
                      <p>{skill.name}</p>
                    </nav>
                  </div>
                ))}
              </div>
              <div className='mr-10 w-96 rounded-[20px] border-4 border-[#B5B5B5] bg-white/20 p-4'>
                {skills.map((skill, index) => (
                  <div key={index}>
                    <input
                      type='text'
            ...
            <div className='bg-[#F8F8F8]/7 flex h-full w-fit flex-col justify-between rounded-[30px] border-4 border-[#2E2B3C] py-4'>
